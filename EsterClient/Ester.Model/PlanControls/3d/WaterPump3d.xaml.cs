...
namespace Ester.Model.PlanControls
{
    ...
    /// </summary>
    public partial class WaterPump3d
    {
        public static readonly DependencyProperty RotationAngleProperty = DependencyProperty.Register(
    "RotationAngle", typeof(int), typeof(WaterPump3d), new PropertyMetadata(0));
    ...
    "InTemp", typeof(double), typeof(WaterPump3d), new PropertyMetadata(0.0, OnInTempChanged));
